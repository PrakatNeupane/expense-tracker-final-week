...
import { Alert, Button, ButtonGroup, Form, ListGroup, Spinner } from "react-bootstrap";
...
export const CustomTable = () => {
	...
	const expensesArg = expenses.filter(expense => expense.type === "expenses")
	...
	return (
		<div className="mt-5 custom-list fs-3">
			<div className="btn-group pb-3">
				...
				<div>All the {display} transactions</div>
			</div>
